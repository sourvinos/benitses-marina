...
import { SafeListVM } from '../classes/view-models/safe-list-vm'
...
export class SafeListComponent {
    ...
    public feature = 'safeList'
    public featureIcon = 'safes'
    public icon = 'home'
    public parentUrl = '/home'
    public records: SafeListVM[] = []
    public recordsFilteredCount: number
    public recordsFiltered: SafeListVM[]
    public selectedRecords: SafeListVM[] = []
