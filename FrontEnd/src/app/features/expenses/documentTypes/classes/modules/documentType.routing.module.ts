...
const routes: Routes = [
    { path: '', component: DocumentTypeListComponent, canActivate: [AuthGuardService], resolve: { expenseDocumentTypeList: DocumentTypeListResolver } },
    { path: 'new', component: DocumentTypeFormComponent, canActivate: [AuthGuardService] },
    { path: ':id', component: DocumentTypeFormComponent, canActivate: [AuthGuardService], resolve: { expenseDocumentTypeForm: DocumentTypeFormResolver } }
]
