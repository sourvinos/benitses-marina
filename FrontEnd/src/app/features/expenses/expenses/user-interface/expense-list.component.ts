...
import { ExpenseListVM } from '../classes/view-models/expense-list-vm'
...
@Component({
    ...
    styleUrls: ['../../../../../assets/styles/custom/lists.css', 'expense-list.component.css']
})
...
export class ExpenseListComponent {
    ...
    public feature = 'expenseList'
    public featureIcon = 'expenses'
    public icon = 'home'
    public parentUrl = '/home'
    public records: ExpenseListVM[] = []
    public recordsFilteredCount = 0
    public filterDate = ''

    public selectedRecords: ExpenseListVM[] = []
    ...
    public onEditRecord(expenseId: string): void {
        this.storeScrollTop()
        this.storeSelectedId(expenseId)
    ...
    private storeSelectedId(expenseId: string): void {
        this.sessionStorageService.saveItem(this.feature + '-id', expenseId)
    }
