...
import { PeriodTypeListVM } from '../classes/view-models/periodType-list-vm'
...
@Component({
    selector: 'periodType-list',
    templateUrl: './periodType-list.component.html',
    styleUrls: ['../../../../../assets/styles/custom/lists.css']
})

export class PeriodTypeListComponent {

    //#region variables

    @ViewChild('table') table: Table

    private url = 'periodTypes'
    private virtualElement: any
    public feature = 'periodTypeList'
    public featureIcon = 'periodTypes'
    public icon = 'home'
    public parentUrl = '/home'
    public records: PeriodTypeListVM[] = []
    public recordsFilteredCount: number
    public recordsFiltered: PeriodTypeListVM[]
    public selectedRecords: PeriodTypeListVM[] = []
