...
import { PeriodTypeHttpService } from '../classes/services/periodType-http.service'
import { PeriodTypeReadDto } from '../classes/dtos/periodType-read-dto'
import { PeriodTypeWriteDto } from '../classes/dtos/periodType-write-dto'
...
@Component({
    selector: 'periodType-form',
    templateUrl: './periodType-form.component.html',
    styleUrls: ['../../../../../assets/styles/custom/forms.css', './periodType-form.component.css']
})

export class PeriodTypeFormComponent {

    //#region common

    private record: PeriodTypeReadDto
    private recordId: number
    public feature = 'periodTypeForm'
    public featureIcon = 'periodTypes'
    public form: FormGroup
    public icon = 'arrow_back'
    public input: InputTabStopDirective
    public parentUrl = '/periodTypes'
    ...
    public onDelete(): void {
        this.dialogService.open(this.messageDialogService.confirmDelete(), 'question', ['abort', 'ok']).subscribe(response => {
            if (response) {
                this.periodTypeHttpService.delete(this.form.value.id).subscribe({
                    complete: () => {
                        this.dexieService.remove('periodTypes', this.form.value.id)
    ...
    private flattenForm(): PeriodTypeWriteDto {
        return {
    ...
    private getRecord(): Promise<any> {
        if (this.recordId != undefined) {
            return new Promise((resolve) => {
                const formResolved: FormResolved = this.activatedRoute.snapshot.data['periodTypeForm']
    ...
    private saveRecord(periodType: PeriodTypeWriteDto): void {
        this.periodTypeHttpService.save(periodType).subscribe({
            next: (response) => {
                this.dexieService.update('periodTypes', {
