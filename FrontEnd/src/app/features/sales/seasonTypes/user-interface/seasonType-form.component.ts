...
import { SeasonTypeHttpService } from '../classes/services/seasonType-http.service'
import { SeasonTypeReadDto } from '../classes/dtos/seasonType-read-dto'
import { SeasonTypeWriteDto } from '../classes/dtos/seasonType-write-dto'
import { SessionStorageService } from 'src/app/shared/services/session-storage.service'
import { SimpleEntity } from 'src/app/shared/classes/simple-entity'

@Component({
    selector: 'seasonType-form',
    templateUrl: './seasonType-form.component.html',
    styleUrls: ['../../../../../assets/styles/custom/forms.css', './seasonType-form.component.css']
})

export class SeasonTypeFormComponent {

    //#region common

    private record: SeasonTypeReadDto
    private recordId: number
    public feature = 'seasonTypeForm'
    public featureIcon = 'seasonTypes'
    public form: FormGroup
    public icon = 'arrow_back'
    public input: InputTabStopDirective
    public parentUrl = '/seasonTypes'
    ...
    public onDelete(): void {
        this.dialogService.open(this.messageDialogService.confirmDelete(), 'question', ['abort', 'ok']).subscribe(response => {
            if (response) {
                this.seasonTypeHttpService.delete(this.form.value.id).subscribe({
                    complete: () => {
                        this.dexieService.remove('seasonTypes', this.form.value.id)
    ...
    private flattenForm(): SeasonTypeWriteDto {
        return {
    ...
    private getRecord(): Promise<any> {
        if (this.recordId != undefined) {
            return new Promise((resolve) => {
                const formResolved: FormResolved = this.activatedRoute.snapshot.data['seasonTypeForm']
    ...
    private saveRecord(seasonType: SeasonTypeWriteDto): void {
        this.seasonTypeHttpService.save(seasonType).subscribe({
            next: (response) => {
                this.dexieService.update('seasonTypes', {
