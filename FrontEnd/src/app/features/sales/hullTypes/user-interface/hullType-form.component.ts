...
import { HullTypeHttpService } from '../classes/services/hullType-http.service'
import { HullTypeReadDto } from '../classes/dtos/hullType-read-dto'
import { HullTypeWriteDto } from '../classes/dtos/hullType-write-dto'
...
@Component({
    selector: 'hullType-form',
    templateUrl: './hullType-form.component.html',
    styleUrls: ['../../../../../assets/styles/custom/forms.css', './hullType-form.component.css']
})

export class HullTypeFormComponent {

    //#region common

    private record: HullTypeReadDto
    private recordId: number
    public feature = 'hullTypeForm'
    public featureIcon = 'hullTypes'
    public form: FormGroup
    public icon = 'arrow_back'
    public input: InputTabStopDirective
    public parentUrl = '/hullTypes'
    ...
    public onDelete(): void {
        this.dialogService.open(this.messageDialogService.confirmDelete(), 'question', ['abort', 'ok']).subscribe(response => {
            if (response) {
                this.hullTypeHttpService.delete(this.form.value.id).subscribe({
                    complete: () => {
                        this.dexieService.remove('hullTypes', this.form.value.id)
    ...
    private flattenForm(): HullTypeWriteDto {
        return {
    ...
    private getRecord(): Promise<any> {
        if (this.recordId != undefined) {
            return new Promise((resolve) => {
                const formResolved: FormResolved = this.activatedRoute.snapshot.data['hullTypeForm']
    ...
    private saveRecord(hullType: HullTypeWriteDto): void {
        this.hullTypeHttpService.save(hullType).subscribe({
            next: (response) => {
                this.dexieService.update('hullTypes', {
