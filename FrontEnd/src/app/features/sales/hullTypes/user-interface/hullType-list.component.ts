...
import { HullTypeListVM } from '../classes/view-models/hullType-list-vm'
...
@Component({
    selector: 'hullType-list',
    templateUrl: './hullType-list.component.html',
    styleUrls: ['../../../../../assets/styles/custom/lists.css']
})

export class HullTypeListComponent {

    //#region variables

    @ViewChild('table') table: Table

    private url = 'hullTypes'
    private virtualElement: any
    public feature = 'hullTypeList'
    public featureIcon = 'hullTypes'
    public icon = 'home'
    public parentUrl = '/home'
    public records: HullTypeListVM[] = []
    public recordsFilteredCount: number
    public recordsFiltered: HullTypeListVM[]
    public selectedRecords: HullTypeListVM[] = []
