...
namespace API.Features.Sales.Transactions {
    ...
    public class InvoicesXmlController : ControllerBase {
        ...
        private readonly ISaleXmlRepository invoiceAadeRepo;
        private readonly ISaleReadRepository invoiceReadRepo;
        private readonly IMapper mapper;

        #endregion

        public InvoicesXmlController(ISaleXmlRepository invoiceAadeRepo, ISaleReadRepository invoiceReadRepo, IMapper mapper) {
        ...
        public async Task<ResponseWithBody> GetByIdAsync(string invoiceId) {
            ...
            if (x != null) {
                return new ResponseWithBody {
                    ...
                    Body = mapper.Map<Sale, SaleXmlBuilderVM>(x)
                };
            } else {
        ...
        private string SaveInvoicePrettyResponse(XmlSaleHeaderVM invoice, string subdirectory, string response) {
