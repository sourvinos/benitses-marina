...
namespace API.Features.Sales.Transactions {
    ...
    public class InvoiceXmlRepository : ISaleXmlRepository {
        ...
        public string SaveInvoiceResponse(XmlSaleHeaderVM invoiceHeader, string subdirectory, string response) {
