...
namespace API.Features.Sales.Transactions {
    ...
    public class InvoicePdfRepository : ISalePdfRepository {

        public string BuildPdf(SalePdfVM invoice) {
        ...
        public string BuildMultiPagePdf(IEnumerable<SalePdfVM> invoices) {
            PdfDocument document = new();
            GlobalFontSettings.FontResolver = new FileFontResolver();
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
            XFont logoFont = new("ACCanterBold", 20);
        ...
        private static void AddIssuer(XGraphics gfx, XFont logoFont, XFont robotoMonoFont, SalePdfVM invoice) {
            var top = 42;
            var left = 40;
        ...
        private static void AddInvoiceDetails(XGraphics gfx, XFont robotoMonoFont, SalePdfVM invoice) {
            var top = 29;
            var right = 560;
        ...
        private static void AddTripDetails(XGraphics gfx, XFont robotoMonoFont, SalePdfVM invoice) {
            var top = 79;
            var right = 560;
        ...
        private static void AddCounterPart(XGraphics gfx, XFont robotoMonoFont, SalePdfVM invoice) {
            var top = 150;
            var left = 40;
        ...
        private static void AddFirstPort(XGraphics gfx, XFont robotoMonoFont, CultureInfo locale, SalePdfVM invoice) {
            var top = 250;
            var left = 40;
        ...
        private static void AddSecondPort(XGraphics gfx, XFont robotoMonoFont, CultureInfo locale, SalePdfVM invoice) {
            var top = 250;
            var left = 250;
        ...
        private static void AddPortTotals(XGraphics gfx, XFont robotoMonoFont, CultureInfo locale, SalePdfVM invoice) {
            var top = 250;
            var left = 450;
        ...
        private static void AddSummary(XGraphics gfx, XFont robotoMonoFont, XFont robotoMonoFontBig, CultureInfo locale, SalePdfVM invoice) {
            var top = 420;
            var left = 450;
        ...
        private static void AddBalances(XGraphics gfx, XFont robotoMonoFont, XFont robotoMonoFontBig, CultureInfo locale, SalePdfVM invoice) {
            var top = 520;
            var left = 450;
            var amountsRight = 560;
        ...
        private static void PrintAade(XGraphics gfx, XFont font, SalePdfAadeVM aade) {
            var bottom = 810;
            var right = 560;
        ...
        private static void AddBankAccounts(XGraphics gfx, XFont robotoMonoFont, SalePdfVM invoice) {
            var bottom = 820;
            var left = 40;
