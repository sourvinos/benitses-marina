...
namespace BoatTypes {
    ...
    [Collection("Sequence")]
    public class BoatTypes01Get : IClassFixture<AppSettingsFixture> {
        ...
        public BoatTypes01Get(AppSettingsFixture appsettings) {
        ...
        public async Task Admins_Can_List() {
            ...
            var records = JsonSerializer.Deserialize<List<BoatTypeListVM>>(await actionResponse.Content.ReadAsStringAsync(), new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
