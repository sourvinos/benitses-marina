...
namespace BoatTypes {
    ...
    [Collection("Sequence")]
    public class BoatTypes03GetById : IClassFixture<AppSettingsFixture> {
        ...
        private readonly string _url = "/boatTypes/1";
        private readonly string _notFoundUrl = "/boatTypes/9999";

        #endregion

        public BoatTypes03GetById(AppSettingsFixture appsettings) {
