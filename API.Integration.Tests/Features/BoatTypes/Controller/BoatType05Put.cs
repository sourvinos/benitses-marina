...
namespace BoatTypes {
    ...
    [Collection("Sequence")]
    public class BoatTypes05Put : IClassFixture<AppSettingsFixture> {
        ...
        private readonly string _notFoundUrl = "/boatTypes/9999";

        #endregion

        public BoatTypes05Put(AppSettingsFixture appsettings) {
        ...
        [Theory]
        [ClassData(typeof(UpdateValidBoatType))]
        ...
        [Theory]
        [ClassData(typeof(UpdateValidBoatType))]
        public async Task Simple_Users_Can_Not_Update(TestBoatType record) {
        ...
        [Theory]
        [ClassData(typeof(UpdateInvalidBoatType))]
        public async Task Admins_Can_Not_Update_When_Invalid(TestBoatType record) {
        ...
        [Theory]
        [ClassData(typeof(UpdateValidBoatType))]
        public async Task Admins_Can_Update_When_Valid(TestBoatType record) {
