...
namespace BoatTypes {
    ...
    [Collection("Sequence")]
    public class BoatTypes06Delete : IClassFixture<AppSettingsFixture> {
        ...
        private readonly string _url = "/boatTypes/4";
        private readonly string _notFoundUrl = "/boatTypes/9999";

        #endregion

        public BoatTypes06Delete(AppSettingsFixture appsettings) {
