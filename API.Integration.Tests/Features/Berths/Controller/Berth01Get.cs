...
namespace Berths {
    ...
    [Collection("Sequence")]
    public class Berths01Get : IClassFixture<AppSettingsFixture> {
        ...
        public Berths01Get(AppSettingsFixture appsettings) {
        ...
        public async Task Admins_Can_List() {
            ...
            var records = JsonSerializer.Deserialize<List<BerthListVM>>(await actionResponse.Content.ReadAsStringAsync(), new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
