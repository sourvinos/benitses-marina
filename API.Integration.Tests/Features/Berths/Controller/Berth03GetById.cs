...
namespace Berths {
    ...
    [Collection("Sequence")]
    public class Berths03GetById : IClassFixture<AppSettingsFixture> {
        ...
        private readonly string _url = "/berths/1";
        private readonly string _notFoundUrl = "/berths/9999";

        #endregion

        public Berths03GetById(AppSettingsFixture appsettings) {
